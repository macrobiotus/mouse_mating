 ...
 * re-encoded diets in 
   * `000_r_format_data.r`
   * `010_r_define_obesity.r`
 * added stops to now superflous scripts
   * `020_r_h1.r`
   * `030_r_h2.r`
   * `040_r_h3.r`
...
## 18-06-2024 - work day 95 - revising manuscript and array analysis
  
 * updated to do

## 19-06-2024 - work day 96 - revising manuscript and array analysis
 ...
 * **display items**
   ...
   * [ ] revise Fig 2 (weight deltas) - ~~add weight gain curves as sub-plot~~ - add tests to bars - adjust caption
